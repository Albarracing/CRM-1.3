    ...
    <div className="containercon">
      ...
      <div  className="conte col-6">
          ...
          {/* <form  className="row g-3"> */}
              ...
              <input type="text"  className="usua form-control" placeholder='Usuario' name="usuario" id="usuario" onChange={this.handleChange} value={form?form.usuario:''}/>
              <input type="Password"  className="pass form-control" placeholder='Contraseña' name="contraseña" id="contraseña" onChange={this.handleChange} value={form?form.contraseña:''}/>

              </div>
              <div className="nombreape">
              <input type="text"  className="usu form-control" placeholder='Nombre' name="nombre" id="nombre" onChange={this.handleChange} value={form?form.nombre:''}/>
              <input type="text"  className="usu form-control" placeholder='Apellido' name="apellido" id="apellido" onChange={this.handleChange} value={form?form.apellido:''}/>
                ...
                <input type="text" className="usu form-control" placeholder="Número de Celular" name="telefono" id="telefono" onChange={this.handleChange} value={form?form.telefono:''}/>
                <input type="text" className="usu form-control" placeholder="Email" name="email" id="email" onChange={this.handleChange} value={form?form.email:''}/>
